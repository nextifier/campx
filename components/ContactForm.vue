    ...
    <div class="container lg:max-w-(--breakpoint-xs)">
      ...
      <div v-else>
        ...
        >
          ...
          <nuxt-link
            to="/"
            class="mt-8 rounded-xl bg-blue-600 px-6 py-4 font-semibold tracking-tight text-white"
            v-ripple
          >
...
const to = ref(
  process.env.NODE_ENV === "production"
    ? ["morefood@panoramamedia.co.id", "outbound@huamogroup.com"]
    : ["antonius@panoramamedia.co.id"],
);
const cc = ref(
  process.env.NODE_ENV === "production" ? ["andita@panoramamedia.co.id"] : [],
);
